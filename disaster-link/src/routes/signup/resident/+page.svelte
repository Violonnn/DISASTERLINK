        ...
        confirmPassword:
            confirmPassword === ''
                ...
                : confirmPassword !== password
                    ...
                    : '',
        privacyConsent:
            !privacyConsent ? 'You must agree to the Privacy Notice before registering' : ''
    });
...
<div class="min-h-screen flex flex-col items-center justify-center pt-20 pb-8 md:pt-24 relative cursor-default">
    ...
    >
        <div class="relative w-full flex flex-col items-center">
            ...
            <div class="relative mt-8 grid grid-cols-1 md:grid-cols-3 w-full md:w-140 place-items-center gap-y-1">
                ...
                <div class="relative pb-3 md:col-span-3 w-full text-left">
                    <div class="w-full rounded-lg border border-[#2F4B5D]/30 bg-white/80 p-4 text-[10px] leading-relaxed text-[#0C212F] shadow-sm">
                        <p>
                            By signing up to DisasterLink, you agree to the collection and use of your personal data for account access,
                            safety alerts, and disaster coordination in accordance with the Data Privacy Act of 2012 (RA 10173).
                        </p>
                    </div>
                    <label for="PRIVACY_CONSENT" class="mt-3 flex w-full items-start gap-2 pl-2 text-[11px] text-[#2F4B5D]">
                        <input
                            id="PRIVACY_CONSENT"
                            name="privacyConsent"
                            type="checkbox"
                            ...
                            class="mt-0.5 h-4 w-4 accent-[#2F4B5D]"
                        />
                        <span>I have read and agree to the Privacy Notice.</span>
                    </label>
                    {#if showErrors && errors.privacyConsent}
                        <p class="mt-1 text-[9px] text-red-500 leading-none">{errors.privacyConsent}</p>
                    {/if}
                </div>
